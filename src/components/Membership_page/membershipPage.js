...
function MembershipPage() {
  ...
  return (
    <>
      ...
      <section
        className="bg-[#FAFAFA] min-h-[calc(100vh-120px)] p-[26px_16px] flex flex-col 
      ...
      >
        ...
        <div className="w-[90%] mx-auto max-[1400px]:w-full ">
          <div className="max-w-[1014px] mx-auto">
            <h1 className="text-[36px] font-semibold leading-[40px] text-[#1D1D1F] mb-[14px] text-center max-sm:text-[26px] max-md:leading-[26px]">
              Choose your membership
            </h1>
            <p className="text-[16px] font-medium leading-[17px] text-[#83838D] mb-[80px] text-center max-[1300px]:mb-[24px]">
              Choose plan and experience it now.
            </p>
            <div className="grid grid-cols-3 gap-[24px] items-end max-md:grid-cols-1">
              {loader ? (
                arr?.map(() => <MembershipembershipLoader />)
              ) : (
                <>
                  {memberData?.map((data, index) => (
                    <div className="border-[1.5px] border-solid border-[#F0F0F0] p-[30px_32px] rounded-[12px] bg-white hover:shadow-[0px_4px_10px_0px_#9B9B9B40]">
                      <h3 className="text-[18px] font-bold leading-[21px] text-[#151618CC] mb-[10px]">
                        {data?.SubscriptionName}
                      </h3>
                      <p className="text-[14px] font-normal leading-[16px] text-[#1516188F] mb-[32px]">
                        {data?.Description}
                      </p>
                      {/* <span
                          className={
                            data?.IsDiscount == 1
                              ? "text-[36px] font-semibold leading-[43px] text-[#646466] line-through"
                              : "text-[36px] font-semibold leading-[43px] text-[#120B14]"
                          }
                        > */}
                      {data?.IsDiscount == 1 ? (
                        <>
                          <div className="flex">
                            <div className="flex flex-row ">
                              <span className="text-[36px] font-semibold leading-[43px] text-[#83838D] line-through mr-3">
                                ${data?.InitialPayment}
                              </span>
                              <div className="flex">
                                ...
                                <h2 className="text-[16px] font-normal text-[#1516188F] mt-3 ">
                                  /
                      ...
                      {/* </span> */}
                      <Link
                        className="bg-[#1D1D1F] border border-[#D8D8D8] text-[14px] leading-[16px] p-[12px] w-full block h-[42px] font-semibold text-[#FFFFFF] mt-[17px] rounded-[4px] text-center hover:bg-[#28282c]"
                        href={`/membership/${data?.Id}`}
                      >
                        Choose plan
                      </Link>
                    </div>
