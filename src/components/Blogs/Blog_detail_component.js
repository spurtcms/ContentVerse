...
const Blog_detail_component = ({ postes, Total_Blogs_api_result, params }) => {
  ...
  let currentIndex = total_blogs_arr?.findIndex(
    (item) => item?.slug === params
  );
  ...
  return (
    <>
      <div>
        ...
        <section>
          <div className="flex flex-col items-center mx-auto mb-[44px] max-[700px]:mb-[38px] px-[16px] py-[17px] max-w-[1295px]">
            <p className="mb-[30px] font-normal text-[20px] text-center">
              ...
              {Detail_Result?.readingTime > 1 ? "minutes" : "minute"} read
              {/* October 19, 2023 4 minutes read */}
            </p>
            <h4 className="mx-auto mb-[30px] max-w-[1188px] text-[#120B14] text-[70px] text-center max-[600px]:text-[42px] leading-[88px]">
              {Detail_Result?.title}
            </h4>
          ...
          <div className="flex flex-col items-start gap-[40px] mx-auto mb-[124px] max-[700px]:mb-[38px] px-[16px] max-w-[1076px]">
            <div>
              <div
          ...
          <div className="flex max-[500px]:flex-col justify-between items-start gap-[16px] mx-auto mb-[47px] px-[16px] max-w-[1296px]">
            {/* {previousData && <> */}
            <a
              href={`/blogs/${previousData?.slug}`}
              className="flex flex-col items-start"
              style={{ visibility: previousData ? "" : "hidden" }}
            >
              <p className="border-[#EDEDED] mb-[17px] max-[500px]:mb-[12px] pb-[20px] max-[500px]:pb-[14px] border-b border-solid font-normal text-[25px] max-[500px]:text-[18px]">
                Previous blog
              </p>
              <h5 className="py-[15px] line-clamp-3 max-w-[458px] font-normal text-[#120B14] text-[36px] max-[500px]:text-[24px]">
                {previousData?.title}
              </h5>
            </a>
            {/* </>} */}
            ...
            <a
              href={`/blogs/${nextData?.slug}`}
              className="flex flex-col items-end pb-[15px]"
              style={{ visibility: nextData ? "" : "hidden" }}
            >
              <p className="text-right border-[#EDEDED] mb-[17px] max-[500px]:mb-[12px] pb-[20px] max-[500px]:pb-[14px] border-b border-solid font-normal text-[25px] max-[500px]:text-[18px]">
                Next blog
              </p>
              <h5 className="text-right py-[15px] line-clamp-3 max-w-[458px] font-normal text-[#120B14] text-[36px] max-[500px]:text-[24px] pb-0">
                {nextData?.title}
              </h5>
            </a>
          </div>
 ...
 */}
          <div className="relative bg-image">
            ...
            <div className="relative z-20 flex max-[800px]:flex-col justify-between items-end gap-[18px] mx-auto px-[16px] max-[500px]:py-[32px] pt-[83px] pb-[122px] max-w-[1295px]">
              ...
              <Link
                href="/membership"
                className="flex items-center bg-[#F33151] hover:bg-[#f15e76] px-[46px] max-[500px]:px-[23px] rounded-[50px] max-w-[269px] h-[79px] font-medium text-[24px] text-white max-[500px]:text-[18px] whitespace-nowrap"
              >
                Sign up for free
              </Link>
            </div>
