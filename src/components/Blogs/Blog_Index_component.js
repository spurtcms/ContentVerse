                ...
                <section>
                    <div className="mx-auto mb-[105px] max-[998px]:mb-[28px] px-[16px] max-w-[1295px]">
                        <h2 className="font-normal text-[66px] max-[500px]:text-[28px] max-[998px]:text-[48px] leading-[1.2]">
                            ...
                            web. */}
                            <span className="font-[700]">Welcome to a Space Where Ideas Take Shape! </span>
                            From decoding tech trends to capturing your latest travel tales, <span className="font-[700]">
                                ...
                                <div className="flex max-[550px]:flex-col items-start gap-[45px] pb-[77px] max-[700px]:pb-[38px]">
                                    ...
                                    <div className="flex flex-col pr-[15px] w-full max-w-[541px]">
                                        ...
                                        <div className="flex flex-col items-start">
                                            <p className="mb-[14px] text-[#120B14] text-[18px] text-normal">{moment(Best_stories_api_result?.[0]?.createdOn).format("MMM DD, YYYY")} by @{`${Best_stories_api_result?.[0]?.authorDetails?.firstName} ${Best_stories_api_result?.[0]?.authorDetails?.lastName}`} {" "}
                                                in
                                                #{Best_stories_api_result?.[0]?.categories?.[0]?.[0]?.categoryName}</p>
                                            <Link href={`/blogs/${Best_stories_api_result?.[0]?.slug}`} legacyBehavior>

                                                <a
                                                    className="mb-[24px] font-medium text-[#120B14] text-[44px] max-[500px]:text-[28px] hover:underline leading-[54px] max-[500px]:leading-normal">
                                        ...
                                        {Best_stories_api_result?.slice(1, 5)?.map((val, i) => (
                                            <Fragment key={i}>
                                                <div className="flex flex-col items-start">
                                                    ...
                                                    <a href={`/blogs/${val?.slug}`} className="font-medium text-[#120B14] text-[26px] hover:underline">
                                                        {val?.title}
                                                    </a>
                                                </div>
                    ...
                    <div className="relative bg-image">
                        ...
                        <div
                            className="relative z-20 flex max-[800px]:flex-col justify-between items-end gap-[18px] mx-auto px-[16px] max-[500px]:py-[32px] pt-[69px] pb-[58px] max-w-[1295px]">
                            <div>
                                <h4 className="mb-[47px] font-medium text-[46px] text-white max-[500px]:text-[28px]">Join <span
                                    className="font-[700]">spurtcms</span> Register for free, and upgrade when you love
                                    it.</h4>
                    ...
                    <div className="mx-auto mb-[105px] px-[16px] pt-[85px] max-w-[1295px]">
                        <div className="border-[#1516183D] pb-[37px] border-b border-solid">
                            <h3 className="font-[700] text-[#120B14] text-[46px]">What’s New?</h3>
                        </div>
                        {
                            Total_blogs_apiresult?.length == 0 ? <>
                                ...
                                <div className="mb-[99px] max-[500px]:mb-[38px]">
                                    {Total_blogs_apiresult?.slice(0, visibleCount)?.map((val, i) => (
                                        <Fragment key={i}>
                                            ...
                                            <div
                                                className="flex max-[600px]:flex-col-reverse justify-between items-start gap-[16px] border-[#1516183D] py-[40px] last:pb-0 border-b last:border-b-0 border-solid max-w-[500px]:mb-[32px]">
                                                ...
                                                <div className="flex flex-col items-start max-w-[832px] max-[600px]:max-w-full">
                                                    ...
                                                    <Link href={`/blogs/${val?.slug}`} className="my-[10px] font-medium text-[#120B14] text-[60px] max-[998px]:text-[32px] hover:underline leading-[1.2]">
                                                        {val?.title}
                                                    </Link>
                                                    {val?.description ? (
                                                        <h6
                                ...
                                <div className="gap-[27px] grid grid-cols-4 max-[500px]:grid-cols-1 max-[800px]:grid-cols-2 mb-[119px] ">
                                    {Recomended_blogs_apiresult?.slice(0, 4)?.map((val, i) => (
                                        <Fragment key={i}>
                                            <a href={`/blogs/${val?.slug}`} className="flex flex-col items-start group">
                    ...
                    <div className="relative bg-image">
                        ...
                        <div className="relative z-20 flex max-[800px]:flex-col justify-between items-end gap-[18px] mx-auto px-[16px] max-[500px]:py-[32px] pt-[83px] pb-[122px] max-w-[1295px]">
                            <div className="flex flex-col items-start">
                                ...
                                <p className="font-normal text-[40px] text-white max-[500px]:text-[28px]">Unlock full access to <span className="font-medium">spurtcms</span> and see the entire library of <span className="font-medium">paid-members</span> only posts</p>
                            </div>
                            <Link href="/membership" className="flex items-center bg-[#F33151] hover:bg-[#f15e76] px-[46px] max-[500px]:px-[23px] rounded-[50px] max-w-[465px] h-[79px] font-medium text-[24px] text-white max-[500px]:text-[18px] whitespace-nowrap">Sign up for free</Link>
                        </div>
                    </div>
                    <div className="mx-auto px-[16px] pt-[109px] max-[500px]:pt-[48px] max-w-[1295px]">
                        <div className="flex max-[600px]:flex-col justify-between items-end gap-[16px] border-[#1516183D] mb-[62px] pb-[2.625rem] border-b border-solid">
                            <div className="flex flex-col items-start max-w-[587px]">
                                <h4 className="mb-[50px] font-[700] text-[#151515] text-[54px] max-[500px]:text-[32px]">SpurtCMS</h4>
                                <p className="font-normal text-[#211F1F] text-[20px]">Versatile and functional theme for running a free or paid-membership publication on Ghost.</p>
                            </div>
